...
class LoginController: UIViewController, UITextFieldDelegate {
    ...
    lazy var profileImageView: UIImageView = {
        ...
        img.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(handleSelectProfileImageView)))
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(r: 34, g: 69, b: 124)
        ...
        setupLogRegButton()
        setupProfileView()
        setupLoginRegisterSegmententedControl()
    ...
    func setupLoginRegisterSegmententedControl(){
